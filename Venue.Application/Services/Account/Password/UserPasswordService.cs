...
namespace Venue.Application.Services.Account
{
    public class UserPasswordService : IUserPasswordService
    {
        ...
        public UserPasswordService(Logger<UserPasswordService> logger, UserManager<User> userManager, SignInManager<User> signInManager, ICurrentUserService currentUserService)
        {
            this.logger = logger;
