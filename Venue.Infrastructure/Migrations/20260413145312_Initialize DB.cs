        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactInfo_Location = table.Column<Point>(type: "geometry", nullable: false),
                    ContactInfo_Address = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    Info_AvailableDays = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Info_SeatingCapacity = table.Column<int>(type: "int", nullable: false),
                    Info_PricePerEvent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Venues_AspNetUsers_UpdatedById",
